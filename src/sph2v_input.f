      ...
      dimension x(MXMSZ)
      character*80 mfl
      integer dx,nlt,nln,npoints

c    read sph model
cp      write(6,*) 'Give input file .sph'
      read(5,111) mfl
111   format(a80)
...
cp      read(5,*,end=99) xlt,xln,dep
cp      write(6,*) 'Give depth'
      read(5,*) dep

cp      write(6,*) 'Give points file'
cp      read(5,*) dx
      open(33,file='points.dat',status='old')
      read(33,*) npoints
...
c    calculate spline coefficients
      ...
      rcmb=3480.
      rmoho=6346.619	!cp changed to be more consistent with libs! 
      rearth=6371.
      r=rearth-dep
      ...
      write(6,112) xlt,xln,dv*100.
      
      enddo

      close(33)

112   format(f9.2,f9.2,f13.5)
